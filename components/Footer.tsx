...
export default function Footer() {
  return (
    <>
      {/* Get notified strip */}
      <section className="bg-yellow text-navy">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 rounded-full px-5 py-3 text-charcoal placeholder:text-charcoal/50 focus:outline-none focus:ring-2 focus:ring-navy"
            />
            <button
              type="submit"
              className="rounded-full bg-navy px-6 py-3 font-semibold text-white hover:bg-navy/90 transition"
            >
              Sign Up
            </button>
          </form>
