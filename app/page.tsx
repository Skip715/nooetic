  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-mist">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 pt-16 pb-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full bg-navy/5 px-4 py-1.5 text-xs font-semibold text-navy mb-6">
            ...
            <h1 className="font-display text-5xl md:text-6xl font-semibold text-navy leading-[1.05] mb-6">
              ...
              <br />
              <span className="text-blue">Pay less.</span>
            </h1>
          ...
          <div className="relative">
            <div className="absolute -top-6 right-6 z-10 hidden sm:flex items-center gap-1.5 rounded-full bg-navy px-4 py-2 text-xs font-semibold text-yellow shadow-lg">
              ⚡ Instant Member Access
            </div>
            <div className="rounded-3xl bg-white shadow-xl shadow-navy/10 p-8 border border-black/5">
              <span className="inline-block rounded-full bg-blue/10 px-3 py-1 text-xs font-semibold text-blue mb-5">
                UK REGULATED WELLNESS NETWORK
              </span>
              ...
              <p className="text-3xl font-semibold text-charcoal mb-6">
                £8<span className="text-base font-normal text-charcoal/60">/mo</span>
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  "Discounted consultation rates",
                  "Exclusive CBD & wellness deals",
                  "Early access to partner launches",
                  "Priority booking with specialists",
                  "Growing network savings",
                ].map((item) => (
              ...
              <Link
                href="/join"
                className="block text-center rounded-full bg-navy px-6 py-3.5 font-semibold text-white hover:bg-navy/90 transition"
              >
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link
              href="/pricing"
              className="inline-block rounded-full bg-blue px-7 py-3.5 font-semibold text-white hover:brightness-95 transition"
            >
