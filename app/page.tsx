...
const CATEGORIES = [
  ...
  { label: "Supplements & holistic", img: "https://images.unsplash.com/photo-1499002238440-d264edd596ec?w=400&q=80" },
  { label: "CBD & recovery", img: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400&q=80" },
  { label: "Travel & retreats", img: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&q=80" },
];
...
const DEALS = [
  {
    ...
    img: "https://images.unsplash.com/photo-1571907480495-a8de13d7be0f?w=600&q=80",
  },
  {
      ...
      <section className="px-6 md:px-12 py-20 bg-sage-deep">
        <div className="grid md:grid-cols-2 gap-14 items-center max-w-5xl mx-auto">
          <div>
            ...
            <a
              href="/join"
              className="inline-block bg-tide-coral text-white px-7 py-3 font-medium hover:bg-white hover:text-sage-deep transition-colors"
            >
              Become a member
            </a>
          </div>
